package com.multistack.petsapi.petsapi.api.adocao.services;
...
import com.multistack.petsapi.petsapi.api.adocao.mappers.AdocaoMapper;
import com.multistack.petsapi.petsapi.core.repositories.AdocaoRepository;
...
public class AdocaoService {
	...
	public List<AdocaoResponse> findAll() {
		return adocaoRepository.findAll().stream().map(adocaoMapper::toResponse).toList();
	}
